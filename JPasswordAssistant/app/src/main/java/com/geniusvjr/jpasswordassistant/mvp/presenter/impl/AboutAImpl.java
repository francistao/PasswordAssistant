...
import com.geniusvjr.jpasswordassistant.mvp.model.bean.AboutDB;
import com.geniusvjr.jpasswordassistant.mvp.presenter.ActivityPresenter;
import com.geniusvjr.jpasswordassistant.mvp.ui.activity.WebViewActivity;
...
public class AboutAImpl implements ActivityPresenter{
    ...
    public void codeClick(View view){
        ...
        bundle.putString("URL", "http://blog.csdn.net/codeemperor?viewmode=contents");
