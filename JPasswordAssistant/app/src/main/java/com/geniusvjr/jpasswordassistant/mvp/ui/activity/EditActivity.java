...
import com.geniusvjr.jpasswordassistant.mvp.presenter.impl.EditAImpl;
...
import com.geniusvjr.jpasswordassistant.widget.spinner.NiceSpinner;
...
public class EditActivity extends BaseSwipeBackActivity implements EditAView {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        if(mEditImpl.onOptionItemSelected(item))
            return true;
    ...
    public void showDialog(String msg, String positiveMsg) {
        ...
        builder.setPositiveButton(positiveMsg, (DialogInterface.OnClickListener) mEditImpl);
        builder.setNegativeButton("取消", (DialogInterface.OnClickListener) mEditImpl);
