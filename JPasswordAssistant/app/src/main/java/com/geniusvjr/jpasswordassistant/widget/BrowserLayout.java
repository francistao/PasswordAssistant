package com.geniusvjr.jpasswordassistant.widget;
...
public class BrowserLayout extends LinearLayout{
    ...
    private void init(Context context) {
        ...
        addView(mBrowserControllerView, WindowManager.LayoutParams.MATCH_PARENT, WindowManager.LayoutParams.WRAP_CONTENT);
    }
